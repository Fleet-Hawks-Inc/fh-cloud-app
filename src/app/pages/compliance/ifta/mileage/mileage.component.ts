...
export class MileageComponent implements OnInit {
  ...
  constructor(private apiService: ApiService,
    private spinner: NgxSpinnerService, private route: ActivatedRoute, private listService: ListService,
  ...
  async getCanadaStates() {
    let states = await this.countryStateCity.GetStatesByCountryCode(["CA"])
  ...
  async getUSStates() {
    let states = await this.countryStateCity.GetStatesByCountryCode(['US'])
    states.forEach(element => {
