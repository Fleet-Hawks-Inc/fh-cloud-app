...
import { DsSummaryComponent } from './ds-summary/ds-summary.component';
import { DsDetailComponent } from './ds-detail/ds-detail.component';


const routes: Routes = [
  { path: 'overview', component: DsOverviewComponent },
  { path: 'summary', component: DsSummaryComponent },
  { path: 'detail', component: DsDetailComponent },
...
export class ManageDriverScorecardModule {}
