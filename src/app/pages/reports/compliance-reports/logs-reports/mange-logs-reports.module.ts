...
const routes: Routes = [
  { path: 'overview', component: LogsOverviewComponent },
  { path: 'summary', component: LogsSummaryComponent },
  { path: 'detail', component: LogsDetailComponent },
...
export class ManageLogsReportsModule {}
