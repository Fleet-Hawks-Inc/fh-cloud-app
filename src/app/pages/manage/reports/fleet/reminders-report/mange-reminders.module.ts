...
const routes: Routes = [
  ...
  { path: 'sreminders', component: SremindersComponent },
  { path: 'vehicle-renewals', component: VehicleRenewalsComponent },
  { path: 'contact-renewals', component: ContactRenewalsComponent },
];
