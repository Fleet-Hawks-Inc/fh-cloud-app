import {
  ...
  import * as addOrdersComponent from 'src/app/pages/dispatch/orders/add-orders/add-orders.component';
    ...
    fetchTripDetail() {
      ...
      this.apiService
        ...
        .subscribe(async (result: any) => {
          ...
          this.tripData["reeferTemperture"] = result.reeferTemperature;
          ...
          for (let i = 0; i < tripPlanning.length; i++) {
            ...
            this.trips.push(obj);
            this.orderIDD["orderIDD"] = this.route.snapshot.params["orderIDD"];
