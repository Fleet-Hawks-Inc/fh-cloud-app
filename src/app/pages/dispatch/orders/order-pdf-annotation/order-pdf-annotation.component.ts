...
declare var $: any;
@Component({
  selector: 'app-order-pdf-annotation',
  templateUrl: './order-pdf-annotation.component.html',
  styleUrls: ['./order-pdf-annotation.component.css']
})
export class OrderPdfAnnotationComponent implements OnInit {
  public modalBody = '';
  pdfMapping = [{
