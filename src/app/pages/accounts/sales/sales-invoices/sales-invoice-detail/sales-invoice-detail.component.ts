...
export class SalesInvoiceDetailComponent implements OnInit {
  ...
  emailDisabled = false;
  sessionID: string;
  constructor(public accountService: AccountService, private toaster: ToastrService, private modalService: NgbModal, public apiService: ApiService, private route: ActivatedRoute, private routerMgmtService: RouteManagementServiceService) { this.sessionID = this.routerMgmtService.salesInvoiceSessionID; }
