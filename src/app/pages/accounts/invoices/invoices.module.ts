...
const routes: Routes = [
  ...
  {
    path: "add-load-invoice",
    component: AddLoadInvoiceComponent,
    data: { title: "Add Load Invoice" },
  },
  {
    path: "load-invoice-detail/:invID",
    component: LoadInvoiceDetailComponent,
    data: { title: "Load Invoice Detail" },
  },
];
