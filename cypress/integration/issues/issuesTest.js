...
it('search-reset issue', function() {
  ...
  cy.get('.pl-0 > .input-group > .ng-select > .ng-select-container > .ng-value-container > .ng-input > input').type('tesla car{enter}');
...
it('Delete Issue', function() {
  ...
  cy.get('#btnsubmit').click();
  cy.get(':nth-child(7) > .nav-link > .fas').click();
  cy.get(':nth-child(2) > :nth-child(8) > .btn-group > .mb-1 > .fas').click();
  cy.get(':nth-child(2) > :nth-child(8) > .btn-group > .dropdown-menu > button.dropdown-item').click();
  /* ==== End Cypress Studio ==== */
});
/* === Test Created with Cypress Studio === */
