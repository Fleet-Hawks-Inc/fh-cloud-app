...
describe("Assets Test", function () {
    ...
    it("should allow the user to add asset", function () {
        ...
        cy.get('.adddriverpl.form-group.pt-3.row input[name="assetIdentification"]').type("Cacadiaa 1366"); //asset name
        cy.get('.inner-wrapper [name="VIN"]').type("HH4DC2390LS002470"); //vin number
        ...
        cy.get(
            'div:nth-of-type(3) > div:nth-of-type(2) > div:nth-of-type(1) > ng-select[role="listbox"] input[role="combobox"]').click();
    ...
    it(".should allow users to delete assets.", function () {
        ...
        cy.get(".ng-star-inserted > .nav > :nth-child(4) > .nav-link")
            ...
            cy.get('#dropdownMenuButton-0').click({force: true});
            cy.get('.dropdown-menu.show > a:nth-of-type(2)').click({force: true});
        });
