describe("Assets Test", function () {
    ...
    it("should allow the user to add asset", function () {
        ...
        cy.get('form#form_ > div:nth-of-type(2) > div:nth-of-type(2) ng-select#assetType input[role="combobox"]'
        ).first().click();
        ...
        cy.get('form#form_ > div:nth-of-type(2) > div:nth-of-type(2) input[name="assetDetails.height"]').clear();
        
        cy.get('form#form_ > div:nth-of-type(2) > div:nth-of-type(2) input[name="assetDetails.height"]').type("10"); //height
        cy.get(
        ...
        cy.get(':nth-child(5) > .col-lg-10 > .ng-select > .ng-select-container > .ng-value-container > .ng-input > input').first().click();
        cy.get('[role="option"]:nth-of-type(1) .ng-star-inserted').last().click();//inspection form
    ...
    it("should give validation error message when required fields are not provided", function () {
        ...
        cy.get('.col-lg-10 > #inspectionFormID-error').contains('This Field is not allowed to be empty');
    });
});
